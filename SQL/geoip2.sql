...
CREATE TABLE `geolite2_city_locations` (
  ...
  `locale_code` varchar(512) DEFAULT NULL COMMENT 'The locale that the names in this row are in. This will always correspond to the locale name of the file.',
  `continent_code` varchar(512) DEFAULT NULL COMMENT 'The continent code for this location. Possible codes are:  AF - Africa  AS - Asia  EU - Europe \n NA - North America  OC - Oceania  SA - South America',
