Module InternalQRTables
    ...
    Public ReadOnly AlignmentPatternLocations As Integer()() = New Integer()() {New Integer() {}, New Integer() {}, New Integer() {6, 18}, New Integer() {6, 22}, New Integer() {6, 26}, New Integer() {6, 30},
    ...
    Public ReadOnly NormalModes As Mode() = New Mode() {Mode.ECI, Mode.Numeric, Mode.AlphaNumeric, Mode.[Byte], Mode.Kanji, Mode.StructuredAppend,
        Mode.FNC1_FirstPosition, Mode.FNC1_SecondPosition, Mode.Terminator}

    Public ReadOnly MicroModes As Mode()() = New Mode()() {Nothing, New Mode() {Mode.Numeric, Mode.Terminator}, New Mode() {Mode.Numeric, Mode.AlphaNumeric, Mode.Terminator}, New Mode() {Mode.Numeric, Mode.AlphaNumeric, Mode.[Byte], Mode.Kanji, Mode.Terminator}, New Mode() {Mode.Numeric, Mode.AlphaNumeric, Mode.[Byte], Mode.Kanji, Mode.Terminator}}

    Public ReadOnly NormalErrorCorrectionLevels As ErrorCorrection() = New ErrorCorrection() {ErrorCorrection.L, ErrorCorrection.M, ErrorCorrection.Q, ErrorCorrection.H}

    Public ReadOnly MicroErrorCorrectionLevels As ErrorCorrection()() = New ErrorCorrection()() {Nothing, New ErrorCorrection() {ErrorCorrection.None}, New ErrorCorrection() {ErrorCorrection.L, ErrorCorrection.M}, New ErrorCorrection() {ErrorCorrection.L, ErrorCorrection.M}, New ErrorCorrection() {ErrorCorrection.L, ErrorCorrection.M, ErrorCorrection.Q}}
    ...
    Public ReadOnly ErrorCorrectionEncodings As Byte() = New Byte() {0, 1, 0, 3, 2}
    ...
    Public ReadOnly NormalFormatStrings As Tuple(Of ErrorCorrection, Byte, BitArray)() = New Tuple(Of ErrorCorrection, Byte, BitArray)() {Tuple.Create(ErrorCorrection.L, CByte(0), New BitArray(New Boolean() {True, True, True, False, True, True,
    ...
    Public ReadOnly MicroFormatStrings As Tuple(Of Integer, ErrorCorrection, Byte, BitArray)() = New Tuple(Of Integer, ErrorCorrection, Byte, BitArray)() {Tuple.Create(2, ErrorCorrection.M, CByte(0), New BitArray(New Boolean() {True, True, False, False, True, True,
        True, True, False, False, True, False,
    ...
    Public ReadOnly VersionStrings As BitArray() = New BitArray() {Nothing, Nothing, Nothing, Nothing, Nothing, Nothing,
    ...
    Public ReadOnly ExponentTable As Byte() = New Byte() {1, 2, 4, 8, 16, 32,
    ...
    Public ReadOnly LogTable As Byte() = New Byte() {0, 0, 1, 25, 2, 50,
        26, 198, 3, 223, 51, 238,
        27, 104, 199, 75, 4, 100,
    ...
    Public ReadOnly Polynomials As Byte()() = New Byte()() {New Byte() {}, New Byte() {0, 0}, New Byte() {0, 25, 1}, New Byte() {0, 198, 199, 3}, New Byte() {0, 75, 249, 78, 6}, New Byte() {0, 113, 164, 166, 119, 10},
